    ...
    <div className="pt-20 flex flex-col">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-5xl md:text-8xl mb-4 gradient-title">
              Find Your Dream Car With Omeenee Cars
            </h1>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div
            ...
            grid grid-cols-2 lg:grid-cols-6 md:grid-cols-4"
          >
            {carMakes.map((make) => (
              <Link
                key={make.name}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                We have got thousand of verified vehicles from trusted
                dealerships
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Take it for a spin . See how it fits
              </p>
            </div>
            <div className="text-center">
              <div className="bg-blue-100 text-blue-700 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">
                Seamless payment options , acquisition with zero hassle
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 dotted-background text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          >Are you ready to find your dream car?</h2>
