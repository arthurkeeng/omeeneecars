            ...
            <div className="space-y-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-8 py-2 rounded-md border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:outline-none focus:border-gray-900 dark:focus:border-gray-400"
                />
              </div>
              <input
                type="range"
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 mt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-white dark:bg-gray-900 p-3 rounded-lg">
                  ...
                  <div className="text-lg font-bold text-gray-900 dark:text-white mt-1">
                    NGN{formatNumber(results.downPayment)}
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-900 p-3 rounded-lg">
                  ...
                  <div className="text-lg font-bold text-gray-900 dark:text-white mt-1">
                    NGN{formatNumber(results.loanPrincipal)}
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-900 p-3 rounded-lg">
                  ...
                  <div className="text-lg font-bold text-gray-900 dark:text-white mt-1">
                    NGN{formatNumber(results.totalInterest)}
                  </div>
                </div>
