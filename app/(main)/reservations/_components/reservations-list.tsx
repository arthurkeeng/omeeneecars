...
export function ReservationsList({ initialData }) {
  ...
  console.log('upcoming bookings are' , upcomingBookings)
  ...
  return (
    <div className="space-y-6">
      ...
      {pastBookings.length > 0 && (
        <div>
          <h2 className="mb-4">Past Test Drives</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {pastBookings.map(booking =><TestDriveCard
            key={booking.id}
            booking={booking}
            showActions={false}
            isPast
