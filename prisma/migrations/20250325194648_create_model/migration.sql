...
-- CreateEnum
CREATE TYPE "BookingStatus" AS ENUM ('PENDING', 'CANCELLED', 'CONFIRMED', 'COMPLETED', 'NO_SHOW');
...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'Omeenee Cars',
    "address" TEXT NOT NULL,
    "phone" TEXT NOT NULL DEFAULT '08100944296',
    "email" TEXT NOT NULL DEFAULT 'omnidev.build@gmail.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
